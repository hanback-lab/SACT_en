...
이 절에서는 앞에서 설명한 카운터를 응용하여, 실제 논리 회로에서 사용하는 주파수 카운터 Design 방법 을 설명하고 있다. 
...
3비트 카운터의 회로 상태 천이도에서 다음 그림과 같이 101의 데이터 상태에서 110의 데이터 상태로 변경하지 않고, 바로 000로 바뀌는 회로로 Design한다. 
