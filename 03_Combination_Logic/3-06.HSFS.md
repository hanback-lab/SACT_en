...
Let's design a full subtractor using two half subtractors tested previously.

Full subtractor can be designed using two half-subtractors and OR gate as below.
...
1. Prepare project file <a href="./pds/HSFS.zip" download>HSFS.zip</a> for the experiment. 
<br>
...
4. Go to d:＼work＼HSFS folder, where the files are unzipped, and open HSFS project.

<br>

5. Select File > Open to import HSFS.bdf file. Or double-click HSFS on the left side of the project.
...
8. Complete the circuit by importing “HS”, “or2” symbol in the symbol window and connecting them with wire.

<img src="./pds/fsh06.png" alt="p08" style="width: 80%;"><br>

※ HA symbol is HS that tested in 3-4. You can check the internal circuit connection through double-clicking HS symbol.
